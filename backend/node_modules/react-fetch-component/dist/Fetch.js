...
var Fetch = function (_Component) {
  ...
  _createClass(Fetch, [{
    ...
    value: function setCache(cache) {
      this.cache = this.props.cache === true ? new _SimpleCache2.default() : _typeof(this.props.cache) === 'object' ? this.props.cache : null;
    }
  }, {
    ...
    value: function fetch(url, options, updateOptions) {
      ...
      if (this.cache && this.cache.get(url)) {
        ...
        var _promise = this.props.fetchFunction(url, options).then(function (response) {
          var dataPromise = typeof as === 'function' ? as(response) : (typeof as === 'undefined' ? 'undefined' : _typeof(as)) === 'object' ? (0, _utils.parseBody)(response, as) : as === 'auto' ? (0, _utils.parseBody)(response) : response[as]();
